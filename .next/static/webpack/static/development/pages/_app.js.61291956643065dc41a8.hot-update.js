...
var AppProvider = function AppProvider(props) {
  ...
  var _useState4 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])({
    getAndSetUserInfo: function getAndSetUserInfo() {
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function getAndSetUserInfo$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('/api/v1/users/getUserInfo', {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    if (localStorage.wt) {
      functions.getAndSetUserInfo().then(function (res) {
        dispatchUserData(res.data.userData);
        console.log(res);
      })["catch"](function (err) {
        console.log(err);
...
//# sourceMappingURL=_app.js.61291956643065dc41a8.hot-update.js.map