...
/* harmony import */ var _VideoTrailerUrl_VideoTrailerUrl__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./VideoTrailerUrl/VideoTrailerUrl */ "./components/adminIncludes/PostComponents/VideoInformation/VideoTrailerUrl/VideoTrailerUrl.js");
...
var VideoInformation = function VideoInformation(props) {
  ...
  return __jsx("div", {
    ...
    name: 'DisLikes'
  }), __jsx(_VideoTrailerUrl_VideoTrailerUrl__WEBPACK_IMPORTED_MODULE_8__["default"], null));
};
...
/***/ "./components/adminIncludes/PostComponents/VideoInformation/VideoTrailerUrl/VideoTrailerUrl.js":
/*!*****************************************************************************************************!*\
  !*** ./components/adminIncludes/PostComponents/VideoInformation/VideoTrailerUrl/VideoTrailerUrl.js ***!
  \*****************************************************************************************************/
/*! exports provided: default */
...
var VideoTrailerUrl = function VideoTrailerUrl(props) {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])({}),
      state = _useState[0],
      setState = _useState[1];
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {}, []);
  return __jsx("div", {
    className: "VideoTrailerUrl VideoInformationSection"
  }, __jsx("div", {
    className: "title"
  }, __jsx("p", null, "Video Trailer URL")), __jsx("div", {
    className: "editor"
  }, __jsx("input", {
    className: "textInput"
  })));
...
/* harmony default export */ __webpack_exports__["default"] = (VideoTrailerUrl);

/***/ })

})
//# sourceMappingURL=post.js.7805a2e7c9153bdb0298.hot-update.js.map