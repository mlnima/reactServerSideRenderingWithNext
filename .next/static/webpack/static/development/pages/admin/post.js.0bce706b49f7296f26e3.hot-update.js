...
/* harmony import */ var _DropDownWidget_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./DropDownWidget.scss */ "./components/adminIncludes/PostComponents/DropDownWidget/DropDownWidget.scss");
/* harmony import */ var _DropDownWidget_scss__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_DropDownWidget_scss__WEBPACK_IMPORTED_MODULE_8__);
...
var DropDownWidget = function DropDownWidget(props) {
  ...
  var openCloseHandler = function openCloseHandler() {
    state.open ? setState(_objectSpread({}, state, {
      open: false
    })) : setState(_objectSpread({}, state, {
      open: true
  ...
  var RenderTheComponent = function RenderTheComponent() {
    if (state.open) {
  ...
  return __jsx("div", {
    ...
    name: state.icon
  }))), __jsx(RenderTheComponent, props));
};
...
//# sourceMappingURL=post.js.0bce706b49f7296f26e3.hot-update.js.map