webpackHotUpdate("static\\development\\pages\\page\\actors.js",{
...
/* harmony import */ var _components_includes_TagElement_TagElement__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../components/includes/TagElement/TagElement */ "./components/includes/TagElement/TagElement.js");
...
/* harmony import */ var _components_includes_ActorElement_ActorElement__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../components/includes/ActorElement/ActorElement */ "./components/includes/ActorElement/ActorElement.js");
...
/* harmony import */ var next_dist_client_with_router__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! next/dist/client/with-router */ "./node_modules/next/dist/client/with-router.js");
/* harmony import */ var next_dist_client_with_router__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_client_with_router__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _components_includes_Sidebar_Sidebar__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../components/includes/Sidebar/Sidebar */ "./components/includes/Sidebar/Sidebar.js");
...
var actors = function actors(props) {
  ...
  var renderActors = props.actorsSource.metas.map(function (meta) {
    return __jsx(_components_includes_ActorElement_ActorElement__WEBPACK_IMPORTED_MODULE_9__["default"], {
      key: meta._id,
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, __jsx(_components_layouts_AppLayout__WEBPACK_IMPORTED_MODULE_3__["default"], null, __jsx(_components_includes_SiteSettingsSetter_SiteSettingsSetter__WEBPACK_IMPORTED_MODULE_10__["default"], props), __jsx("div", {
    ...
    className: "actors"
  }, renderActors), __jsx(_components_includes_PaginationComponent_PaginationComponent__WEBPACK_IMPORTED_MODULE_11__["default"], {
    isActive: true,
    currentPage: props.getActorsData.pageNo,
    totalCount: props.actorsSource.totalCount,
    size: props.getActorsData.size,
    maxPage: Math.ceil(_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_1___default()(props.actorsSource.totalCount) / _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_1___default()(props.getActorsData.size)) - 1,
    queryData: props.query || props.router.query,
    pathnameData: props.pathname || props.router.pathname
  })), __jsx(_components_includes_Sidebar_Sidebar__WEBPACK_IMPORTED_MODULE_13__["default"], {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_variables_ajaxVariables__WEBPACK_IMPORTED_MODULE_6__["getSetting"])('identity'));

        case 3:
          identityData = _context.sent;
          _context.next = 6;
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_variables_ajaxVariables__WEBPACK_IMPORTED_MODULE_6__["getSetting"])('navigation'));

        case 6:
          navigationData = _context.sent;
          _context.next = 9;
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_variables_ajaxVariables__WEBPACK_IMPORTED_MODULE_6__["getWidgetsWithData"])('actorsPageSidebar'));
        ...
        case 9:
          ...
          _context.next = 16;
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_variables_ajaxPostsVariables__WEBPACK_IMPORTED_MODULE_7__["getMeta"])(getActorsData));
...
/* harmony default export */ __webpack_exports__["default"] = (next_dist_client_with_router__WEBPACK_IMPORTED_MODULE_12___default()(actors));

/***/ })

})
//# sourceMappingURL=actors.js.2cb64a9002248d43d62b.hot-update.js.map