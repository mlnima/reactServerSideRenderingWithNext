...
var PaginationComponent = function PaginationComponent(props) {
  ...
  var numberGen = function numberGen(current) {
    ...
    if (Math.ceil(props.totalCount / props.size)) {
      numArr.push(_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_9___default()(props.maxPage) - 1);
    }

    numArr = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_8__["default"])(new _babel_runtime_corejs2_core_js_set__WEBPACK_IMPORTED_MODULE_7___default.a(numArr));
  ...
  var renderPaginationItems = numberGen(props.currentPage).map(function (page) {
    if (props.router) {
      var newQueryData = props.router.query;
...
/* harmony default export */ __webpack_exports__["default"] = (next_dist_client_with_router__WEBPACK_IMPORTED_MODULE_12___default()(PaginationComponent));

/***/ })

})
//# sourceMappingURL=posts.js.01707eab98afae73a312.hot-update.js.map