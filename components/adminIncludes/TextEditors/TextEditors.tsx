...
const TextEditors = ({value, onChangeHandler, language, height, width, name,use}: TextEditorsPropTypes,) => {
    ...
    const onClickHandler = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        ...
        if (typeof window !== 'undefined') {
            // @ts-ignore
            localStorage.setItem('pe', e.target.name)
        }
        ...
        <TextEditorsStyledDiv className={'text-editors'}>
            ...
            <div className={'text-editors-switcher'}>
                <select className={'custom-select'} onChange={e => onChangeEditorHandler(e)} value={editor}>
                    ...
                    {/*<option value={'SunEditor'}>Sun Editor</option>*/}
                    {/*<option value={'ReactQuillEditor'}> React Quill Editor</option>*/}
                    {/*<option value={'ReactPage'}>React Page</option>*/}
