                    ...
                    {callData.receivingCall && !callData.callAccepted ?
                        <div className='messenger-call-user-calling-message'>
                            ...
                            <div className='messenger-call-user-calling-message-answer-buttons'>
                                <button className='messenger-call-user-calling-message-answer-button' onClick={answerCall}><FontAwesomeIcon style={{width: '20px', height: '20px'}} icon={faPhoneAlt} className=' svg-logo-small'/></button>
