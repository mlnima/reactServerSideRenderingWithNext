        ...
        return (
            <PostsSliderStyledDiv cardWidth={cardWidth}>
                ...
                {uniqueData?.sliderConfig?.navigation ?
                    <>
                        <button onClick={scrollPrev} className={'prev-btn'} disabled={!prevBtnEnabled} aria-label={'previous slide'}>
                        ...
                        <button onClick={scrollNext} className={'next-btn'} disabled={!nextBtnEnabled}  aria-label={'next slide'}>
