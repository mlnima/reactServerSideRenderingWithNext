...
const PostElementStyledArticle = styled.div`
  width: 48vw;
  margin: 2px;
  border: none;
...
const PostElement = props => {
    ...
    return (
        <PostElementStyledArticle className={classNameForPostElement} onMouseOut={isHoverHandler} onTouchCancel={isHoverHandler}>
