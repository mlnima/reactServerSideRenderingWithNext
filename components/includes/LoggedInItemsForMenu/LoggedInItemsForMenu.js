        ...
        if (contextData.siteIdentity.membership) {
            return (
                <Link href={`/profile?username=${contextData.userData.username}`}>
                    <a >
                        <FontAwesomeIcon icon={faUser} className='logged-in-item-logo' style={props.colorsStyle}/>
                    </a>
                </Link>
            )
        } else return null
        ...
        return (
            <div className='logged-in-items'>
                <p  onClick={() => contextData.functions.logOutUser()}>
                    <FontAwesomeIcon icon={faPowerOff} className='logged-in-item-logo' style={props.colorsStyle}/>
                </p>
                <MyProfile/>
            </div>
        )
