    ...
    <xsl:template match="/">
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                ...
                <div id="footer">
                    <p>Google ExpressJs (XML) Sitemaps Generated by Nima Malayeri for ReactJs CMS Project This XSLT
    ...
    <xsl:template match="sitemap:urlset">
        ...
        <div id="intro">
            <p>
                ...
                <br/>
                It was generated only for the React content management system and the by Nima Malayeri
                <br/>
            </p>
        </div>
        <div id="content">
