...
module.exports = async (req, res) => {
    try {
        ...
        const findPostsQueries = {
            $and: [
                findingPostsOptions.postTypeQuery,
                findingPostsOptions.statusQuery,
                findingPostsOptions.authorQuery,
                findingPostsOptions.searchQuery,
                findingPostsOptions.metaQuery
            ]
        }
        ...
        const posts = await postSchema.find(
            ...
            findingPostsOptions.selectedFields,
            {
                ...
                //       findingPostsOptions.size * (findingPostsOptions.page - 1),
