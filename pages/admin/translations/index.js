...
const translations = props => {
    const [activeEditingLanguage, seActiveEditingLanguage] = useState(() => process.env.REACT_APP_DEFAULT_LOCAL);
    ...
    return (
        <div className='translations'>
            ...
            <select onChange={e => onActiveEditingLanguageChangeHandler(e)}>
                ...
                <option value={process.env.REACT_APP_DEFAULT_LOCAL}>{process.env.REACT_APP_DEFAULT_LOCAL || 'Default'}</option>
                {languagesOptions}
