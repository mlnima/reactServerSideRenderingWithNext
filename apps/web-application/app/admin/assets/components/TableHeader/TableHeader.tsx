...
const TableHeader: FC<TableHeaderPropType> = ({ selectedItems, tableItemsType, selectAllAssetsHandler }) => {
  ...
  return (
    <TableHeaderStyledDiv className="asset-page-table-header">
      <input ref={selectAllCheckBox} type="checkbox" className={'asset-table-check-box'} onChange={(e) => selectAllAssetsHandler(e)} />
