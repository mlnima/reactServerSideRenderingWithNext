...
const SwiperWidgetFields: FC<SliderWidgetTypeFieldsPropTypes> = ({ uniqueData, onUniqueDataJsonChangeHandler }) => {
  ...
  return (
    <div className={'monaco-editor-section'}>
      <div className={'open-section'}>
        ...
        <a href={'https://swiperjs.com/demos'} target={'_blank'} className={'btn btn-info section-action'}>
          Examples
        </a>
      </div>
