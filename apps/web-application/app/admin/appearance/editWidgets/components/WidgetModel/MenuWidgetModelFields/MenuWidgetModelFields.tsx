...
import { inputValueSimplifier, nestedObjectModifier } from '@repo/utils/dist/src';
...
const MenuWidgetModelFields: FC<IProps> = ({ widgetSettings, setWidgetData, widgetData, onUniqueDataChangeHandler }) => {
  ...
  const onChangeHandlerWithTranslate = (event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    if (widgetSettings.activeEditingLanguage === 'default') {
      ...
      const modifiedState = nestedObjectModifier(formData, ['translations', widgetSettings.activeEditingLanguage, name], value);
