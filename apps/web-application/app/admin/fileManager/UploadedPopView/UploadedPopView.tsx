  ...
  return (
    <div id={'UploadedPopView'} className="uploaded-pop-view">
      <div className="gallery-pop-view-content">
        <button className="closeBtn" onClick={closePopView} aria-label="Close popup">×</button>
        ...
        <div className="url-container">
          <div className="url-entry">
            <label htmlFor="relativeUrl" className="uploaded-pop-view-url-label">Relative URL:</label>
            <div className="url-input-group">
              <input id="relativeUrl" type="text" value={relativeUrl} readOnly className="uploaded-pop-view-url-text" />
              <button
                className="copy-url-button"
                onClick={() => handleCopyToClipboard(relativeUrl, 'relative')}
              >
          ...
          <div className="url-entry">
            <label htmlFor="absoluteUrl" className="uploaded-pop-view-url-label">Absolute URL:</label>
            <div className="url-input-group">
              <input id="absoluteUrl" type="text" value={absoluteUrl} readOnly className="uploaded-pop-view-url-text" />
              <button
                className="copy-url-button"
                onClick={() => handleCopyToClipboard(absoluteUrl, 'absolute')}
              >
