...
import { headerSizeCalculator } from '@repo/utils/dist/src';
...
const ChatroomPageContent: FC<IProps> = ({ dictionary, locale, chatroom, chatrooms }) => {
  ...
  const initializeChatroomDataHandler = (data: { recentChatRoomMessages: ChatroomMessage[]; onlineUsersList: IChatroomUsers }) => {
