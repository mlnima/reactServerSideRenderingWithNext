...
import VideoPlayersWrapper from './VideoPlayersWrapper/VideoPlayersWrapper';
import PostTitle from '../PostTitle/PostTitle';
import PostDescription from '../PostDescription/PostDescription';
import PostMetasRenderer from '../PostMetasRenderer/PostMetasRenderer';
import ActionButtons from '../ActionButtons/ActionButtons';
import './VideoTypePostPage.styles.scss';

const VideoTypePostPage: FC<PostPageProps> = ({ post, locale, dictionary, views, likes, postType }) => {
  return (
    <>
      <div className={'entry-header'}>
        <VideoPlayersWrapper post={post} dictionary={dictionary} locale={locale} />
...
// <div id={'primary'} className={`postPage ${postType}PostPage`}>