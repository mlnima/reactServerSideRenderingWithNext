import {rootTemplate} from "../asset/xmlTemplateGenerators";
...
export const rootSitemapGenerator = async (baseOutputPath) => {
    try {
       await fs.writeFileSync(`${baseOutputPath}/sitemap.xml`,rootTemplate(`
