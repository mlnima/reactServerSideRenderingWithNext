...
} from "../asset/xmlTemplateGenerators";
import {postSchema} from 'models';
import moment from 'moment';
import mongoDocumentDateCorrector from "../asset/mongoDocumentDateCorrector";
import fs from "fs";

const getRangeOfTheDates = (firstCreatedPostDate, lastUpdatedPostDate) => {
    try {
        let dateArray = [];
...
export const postSitemapLinkForTheRoot = async (baseOutputPath) => {
    try {
