...
const SlideShow: FC<PropTypes> = ({post, sidebar, deviceWidth}) => {
    ...
    const NextBtn = () => {
        ...
        if (state.activeImageIndex >= state.imagesArrayLength - 1) {
            ...
            return (
                <button className='product-slide-show-slide-btn product-slide-show-slide-btn-right'
    ...
    const PreviousBtn = () => {
        if (state.activeImageIndex > 0 && state.imagesArrayLength > 1) {
            return (
                <button className='product-slide-show-slide-btn product-slide-show-slide-btn-left'
