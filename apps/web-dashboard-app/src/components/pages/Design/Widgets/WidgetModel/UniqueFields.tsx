...
import UserPreferenceConfigModelFields from '@components/pages/Design/Widgets/WidgetModel/UserPreferenceConfigModelFields/UserPreferenceConfigModelFields';
import AuthenticationTypeWidgetModelFields from '@components/pages/Design/Widgets/WidgetModel/AuthenticationTypeWidgetModelFields/AuthenticationTypeWidgetModelFields';
    ...
    return (
        <>
            ...
            {widgetData.type === 'authentication' && (
                <AuthenticationTypeWidgetModelFields
                    onUniqueDataChangeHandler={onUniqueDataChangeHandler}
                    widgetData={widgetData}
                />
            )}
