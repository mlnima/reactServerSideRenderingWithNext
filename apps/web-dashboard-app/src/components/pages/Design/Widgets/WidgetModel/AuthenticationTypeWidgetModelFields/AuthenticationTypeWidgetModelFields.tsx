...
import {WidgetData} from "typescript-types/dist/src/widgets/Widget";
...
const AuthenticationTypeWidgetModelFields: FC<IProps> = ({onUniqueDataChangeHandler, widgetData}) => {
