...
export const adminPanelFormsSlice = createSlice({
...
export const adminPanelPostsReducer = (state: RootState) => state?.adminPanelForms || null

export default adminPanelFormsSlice.reducer
